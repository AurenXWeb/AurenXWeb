          ...
          <div className="relative hidden md:block">
            ...
            <div className="relative bg-white/50 backdrop-blur-sm p-8 rounded-3xl border border-[#00BCD4]/20 shadow-xl">
              <div className="space-y-4">
                <div className="bg-gradient-to-r from-[#00BCD4] to-[#0099CC] h-3 w-20 rounded-full"></div>
                <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100">
                  <div className="flex items-center gap-3 mb-4">
                    <div className="w-12 h-12 bg-gradient-to-br from-[#00BCD4] to-[#0099CC] rounded-lg"></div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-white rounded-xl p-4 shadow-md border border-gray-100">
                    <div className="w-8 h-8 bg-[#00BCD4]/20 rounded-lg mb-2"></div>
